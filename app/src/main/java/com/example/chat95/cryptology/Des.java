...
public class Des {
    ...
    public String encrypt(String plainText,String key){
        ...
        while(!splittedPlainTextInHex.isEmpty()){
            ...
            Log.d(TAG, "encrypt: encrypting(in hex): "+tempString+ " length: "+tempString.length());
            encryptedText+=  encryptOnce(tempString,key);   // in hex
            Log.d(TAG, "encrypt: after encryptOnce(in hex): "+encryptedText+" length: "+encryptedText.length());
            splittedPlainTextInHex.remove(0);
        }
...
/*
    ...
    public String decrypt(String cipherText,String key){
        ...
        List<String> splittedCipherText= TextSplitter.split(cipherText,16);
