...
public class BitmapUtils {
    ...
    public byte[] compressAndRotateBitmap(Context context, Uri selectedImage) throws IOException {
        //rotate
        Bitmap bitmapPhoto = HandleSamplingAndRotationBitmap(context, selectedImage);
